...
public class ColorUtils {
    ...
    public static String RED = "#f1453b"; //红色  - 原#e50503
    public static String GREEN = "#38c4a9"; //绿色
    public static int gray = Color.GRAY; //灰色
    public static String BLUE = "#157dfb";
    public static String BGRAY = "#111111"; //黑色
    public static String COMMENT_FONT_COLOR = "#5d3301"; //黑色
     ...
     * 饼状图颜色
     */
    public static String PIE_COLOR[] = {"#40989b", "#03aeb4", "#69c1c4", "#40d5da", "#82a1a2",
            "#5d9064", "#40a94d", "#469d51", "#9fd3a4", "#cbe8ce", "#cc8d42", "#ff8c00", "#cfab80", "#ffaa42",
            "#ffdaac", "#6994c4", "#375e89", "#4a89cf", "#69b0ff", "#9dbee3", "#d39090",
            "#9f5858", "#cd5353", "#cdaf53", "#ecd387", "#e9c045", "#9f81a1", "#b8a4b9", "#4c5060", "#e0e0e0", "#e0e0e0"};
