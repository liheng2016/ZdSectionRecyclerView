...
import tabfragment.ClientFragment;
import tabfragment.HomeFragment;
import tabfragment.IFramePage;
import tabfragment.MarketFragment;
import tabfragment.MyStockFragment;
...
public class MainTabActivity extends BaseActivity implements View.OnClickListener , IFramePage {
    ...
    protected void initView() {
        ...
        fragments.add(new TabInfo("理财", MarketFragment.class));
        fragments.add(new TabInfo("自选", MyStockFragment.class));
        fragments.add(new TabInfo("我的", ClientFragment.class));
        ...
        tabs[3] = (TextView) findViewById(R.id.xct_lthj_frame_text_tab4);
...
//        QuotGlobalInfo.FORWARD_MODEL.setCurrentTab(tabIndex);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.xct_lthj_frame_text_tab1: //计划
                onTabSelected(0);
                break;
            case R.id.xct_lthj_frame_text_tab2: //行情
                onTabSelected(1);
                break;
            case R.id.xct_lthj_frame_text_tab3: //账户分析
                onTabSelected(2);
                break;
            case R.id.xct_lthj_frame_text_tab4: //我的
                onTabSelected(3);
                break;
            default:
                break;
